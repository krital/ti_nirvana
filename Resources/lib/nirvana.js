...
About: Version & Support
    ...
    JavaScript API Version _VERSION_MAJOR_._VERSION_MINOR_ (Build 12314).
...
*/
    ...
    var Nirvana = (function () {
            ...
            function createForeverIFrame(url, onMessageCB, onErrorCB) {
                ...
                if (document.createElement) {
                    ...
                    if (element) {
                        ...
                        //the onload below allows a browser to know when an iframe is loaded.
                        var iframeSubHTML = "<iframe id=\"NVLSubFrame\" onload=\"window.parent.errorCB('iframe_connection_closed')\" src=\"" + url + "\" style=\"";
        ...
        var Transport = (function () {
            ...
            function setPreferredDrivers(userDriverArray, usePreviousBestDriverFlag) {
            ...
            function useNextRealm() {
                ...
                if(currentRealmIndex != newIndex) {
                    ...
                    currentDriverFailureCount = 0;
                    setPreferredDrivers(currentSession.getConfig().drivers, false);
                }
            }
            ...
            function setUp(session, usePreviousBestDriverFlag) {
                ...
                setPreferredDrivers(sessionConfig.drivers, usePreviousBestDriverFlag);
            }
            ...
            function scheduleReset(request, timeout) {
                ...
                if (Utils.isLoggingEnabled()) {
                    Utils.Logger.log(2, "[Transport] Setting Scheduler resetTimeoutID  : " + resetTimeoutID);
                }
            }
    ...
    /*
            ...
            function pushToTransport() {
                if (isReady && outboundQueue.length > 0) {
                    ...
                    if(req !== null){
                        ...
                        Utils.Logger.log(3, "[Outbound Engine] Dequeueing unecessary session start request as already connected.", "Req #" + req.requestID);
        ...
        function createSession(config) {
            ...
            function sanitizeConfiguration(config) {
                ...
                config.sendResponseTimeout = sanitizeInteger(config.sendResponseTimeout, 60000);
        ...
        */
        ...
        return {
            ...
            "BUILD_NUMBER":"Build 12314",
            "BUILD_DATE":"December 2 2013",
